...
interface DynamicIoTChartProps {
  data: ChartDataPoint[];
  title?: string;
  subtitle?: string;
  showArea?: boolean;
...
export function DynamicIoTChart({ 
  data,
  title = "Dynamic IoT Chart", 
  subtitle = "Real-time data visualization",
  showArea = true,
  showLine = true,
  color = "#1E824C",
  yDomain = [0, 3]
}: DynamicIoTChartProps) {
  ...
  // React state label to avoid reading SharedValue during render
  ...
  // console.log('DynamicIoTChart data:', chartData);
  // console.log('DynamicIoTChart props:', { showArea, showLine, color, yDomain });
